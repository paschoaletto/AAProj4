...
import me.apptize.bollyfilmes.BuildConfig;
import me.apptize.bollyfilmes.FilmeDetalheActivity;
import me.apptize.bollyfilmes.ItemFilme;
import me.apptize.bollyfilmes.JsonUtil;
import me.apptize.bollyfilmes.R;
...
public class FilmesSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void notify(ItemFilme itemFilme) {
        ...
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getContext());
        String defaultNotificationPref = getContext().getString(R.string.value_notification_default);
        boolean notifyPrefKey = preferences.getBoolean(getContext().getString(R.string.pref_notification_key), Boolean.parseBoolean(defaultNotificationPref));
